...
dependencies {
    ...
    implementation(project(":feature:appdetail")) // 应用详情（包名 / 大小 / 缓存 / 停用 / 卸载）
    implementation(project(":feature:oneclick"))  // 一键体检（聚合扫描）
    implementation(project(":feature:export"))    // 数据导出（CSV）
